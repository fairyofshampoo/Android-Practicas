...
import com.ikariscraft.desapp03.databinding.ActivityResultBinding;
...
public class ResultActivity extends AppCompatActivity {
    ...
    public static final String WEIGHT_KEY = "pesokey";
    public static final String HEIGHT_KEY = "alturakey";
